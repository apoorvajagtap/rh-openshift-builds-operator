...
require (
	...
	github.com/openshift-pipelines/pipelines-as-code v0.27.1 // indirect
	github.com/openshift/api v0.0.0-20240625084701-0689f006bcde // indirect
	github.com/openshift/apiserver-library-go v0.0.0-20240528110119-d099d1006d9d // indirect
	...
	knative.dev/pkg v0.0.0-20240625144936-ee1db869c7ef // indirect
